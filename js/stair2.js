...
stair2State.prototype.create = function() {
	...
	//DECLARE PLAYER
	this.player = new Player(1300,-50);
	...
	stair2State.addStep(0, 358, 283, 750, terrainCollisionGroup);
	stair2State.addStep(283, 411, 377, 750, terrainCollisionGroup);
	stair2State.addStep(377, 464, 471, 750, terrainCollisionGroup);
	stair2State.addStep(471, 518, 565, 750, terrainCollisionGroup);
	stair2State.addStep(565, 571, 660, 750, terrainCollisionGroup);
	stair2State.addStep(660, 625, 1150, 750, terrainCollisionGroup);
	stair2State.addStep(1150, 679, 1245, 750, terrainCollisionGroup);
	stair2State.addStep(1245, 732, 1334, 750, terrainCollisionGroup);
	stair2State.addStep(0, 745, 1344, 750, terrainCollisionGroup, true);
...
stair2State.prototype.update = function() {
	...
	if (this.player.upperbody.x < 450 || this.player.leftElbowJoint.bodyB.parent.sprite.position.x < 400 
		|| this.player.rightElbowJoint.bodyB.parent.sprite.position.x < 400
		|| this.player.rightKneeJoint.bodyB.parent.sprite.position.x < 400
		|| this.player.leftKneeJoint.bodyB.parent.sprite.position.x < 400) {
